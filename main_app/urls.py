...
urlpatterns = [
    ...
    path('job-board/', views.ListsPost.as_view(), name='gamepost_list'),
    path('job-board/<int:pk>/', views.JobDetail.as_view(), name="job_detail"),
    ...
    # path('job-board/new', views.ArtistCreate.as_view(), name="artist_create"),    
